...
void GUI::loadMedia(){
	...
	objectTextures[Object::Type::powerup] = new Texture();
	objectTextures[Object::Type::powerup]->load(renderer, "./Assets/Images/powerup.png");
...
Vector2D GUI::getDimensions(const Object * object) const
{
	...
	case Object::Type::enemy:
	{
		Vector2D temp{ enemyClips[0]->w, enemyClips[0]->h };
		return temp;
		break;
	}
